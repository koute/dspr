...
class module_vst_t : public module_t
{
    public:

        module_vst_t();
        virtual ~module_vst_t();
...
class meta_module_vst_t : public meta_module_t
{
...
extern meta_module_vst_t g_meta_module_vst;
